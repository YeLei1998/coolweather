package com.example.lei.coolweather.service;
...
import com.example.lei.coolweather.WeatherActivity;
...
public class AutoUpdateService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId){
        ...
        int hours = 2 * 60 * 60 * 1000;     //这里8小时的毫秒数
        long triggerAtTime = SystemClock.elapsedRealtime() + hours; //触发时间: 系统时间实时运行2小时
    ...
    private void updateWeather(){
        ...
        if (weatherStr != null){
            weather = Utility.handleWeatherResponse(weatherStr);
